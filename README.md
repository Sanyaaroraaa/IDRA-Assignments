...
Repository containing daily tasks and assignments completed during the IDRA program.

## Assignments Index

| Day             | File                                                                                                                       | Topic / Description                                                                                          |
| --------------- | -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **Day 01**      | [`Day_01/Calculator.ipynb`](./Day_01/Calculator.ipynb)                                                                     | Basic Calculator implementation                                                                              |
| **Day 02**      | [`GuessingGame.ipynb`](./GuessingGame.ipynb)                                                                               | Number Guessing Game                                                                                         |
| **Day 03**      | [`Day_03/Student_Management_System.ipynb`](./Day_03/Student_Management_System.ipynb)                                       | Student Management System                                                                                    |
...
| **Day 20**      | [`Day_20/Arora_Sanya_Capstone_Notebook.ipynb`](./Day_20/Arora_Sanya_Capstone_Notebook.ipynb)                               | 🌫️ **Final Capstone: Urban Air Quality Analysis** — EDA, statistical analysis, and AQI regression modelling |
...
```bash
git clone https://github.com/Sanyaaroraaa/IDRA-Assignments.git
...
**🎓 IDRA Program · Daily Assignments & Final Capstone**

Completed with 💙 by Sanya Arora
